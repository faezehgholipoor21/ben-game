(function ($) {
    ...
    $('.category_post-btn').on('click', function () {
        $(".main-category_post").toggle();
    });
    ...
    $('.category_post-slider').owlCarousel({
        loop: true,
        margin: 20,
        nav: false,
        dots: false,
        autoplay: false,
        responsive: {0: {items: 2}, 600: {items: 4}, 1000: {items: 6}, 1200: {items: 7}, 1400: {items: 8}}
    });
    ...
    $('[data-countdown]').each(function () {
        ...
        $(this).countdown(finalDate, function (event) {
            $(this).html(event.strftime('<div class="row"><div class="col countdown-item"><h2>%-D</h2><h5>روز</h5></div><div class="col countdown-item"><h2>%H</h2><h5>ساعت</h5></div><div class="col countdown-item"><h2>%M</h2><h5>دقیقه</h5></div><div class="col countdown-item"><h2>%S</h2><h5>ثانیه</h5></div></div>'));
        });
    });
