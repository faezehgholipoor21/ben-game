...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-12">
                <div class="card">
                    <form enctype="multipart/form-data" action="{{route('user.profile_update')}}" method="post"
                          class="card-body">
                        @csrf
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <input type="file" class="dropify" name="profile"
                                               data-default-file="{{asset($user_info['user_image'])}}">
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row clearfix">
            <div class="col-12">
                <div class="card">
                    <form action="{{route('user.changePass')}}" method="post" class="card-body">
                        @csrf
                        <div class="row">
                            <div class="col-12 col-sm-6 col-md-3">
