                ...
                <div class="col-lg-3 mb-5">
                    <div class="product-brand">
                        ...
                        <div class="brand-list">
                            <a href="#"><i class="far fa-objects-column"></i>سامسونگ<span>(10)</span></a>
                            <a href="#"><i class="far fa-objects-column"></i>اپل<span>(15)</span></a>
                            <a href="#"><i class="far fa-objects-column"></i>شائومی<span>(12)</span></a>
                            <a href="#"><i class="far fa-objects-column"></i>سونی<span>(18)</span></a>
                            <a href="#"><i class="far fa-objects-column"></i>گوگل<span>(05)</span></a>
                            <a href="#"><i class="far fa-objects-column"></i>ویوو<span>(14)</span></a>
                            <a href="#"><i class="far fa-objects-column"></i>هوواوی<span>(17)</span></a>
                            <a href="#"><i class="far fa-objects-column"></i>تکنو<span>(08)</span></a>
                        </div>
                        <a href="#" class="theme-btn">مشاهده همه برندها<i class="fas fa-arrow-left"></i></a>
                    </div>
                </div>
                <div class="col-lg-9">
                    <div class="row">
                        <div class="col-12">
                            <div class="site-heading-inline">
                                <h2 class="site-title"><img src="{{asset('site/assets/img/icon/product-list.svg')}}" alt>تلفن های همراه
                                </h2>
                                <a href="#">مشاهده بیشتر <i class="fas fa-arrow-left"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4">
                            <div class="product-item">
                                <div class="product-img">
                                    <span class="type new">جدید</span>
                                    <a href="shop-single.html"><img src="{{asset('site/assets/img/product/p15.png')}}" alt></a>
                                    <div class="product-action-wrap">
                                        <div class="product-action">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                               data-tooltip="tooltip" title="نمایش سریع"><i class="far fa-eye"></i></a>
                                            <a href="#" data-tooltip="tooltip" title="افزودن به لیست علاقه مندی ها"><i
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="product-item">
                                <div class="product-img">
                                    <span class="type hot">داغ</span>
                                    <a href="shop-single.html"><img src="{{asset('site/assets/img/product/p16.png')}}" alt></a>
                                    <div class="product-action-wrap">
                                        <div class="product-action">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                               data-tooltip="tooltip" title="نمایش سریع"><i class="far fa-eye"></i></a>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="product-item">
                                <div class="product-img">
                                    <span class="type oos">در انبار موجود نیست</span>
                                    <a href="shop-single.html"><img src="{{asset('site/assets/img/product/p17.png')}}" alt></a>
                                    <div class="product-action-wrap">
                                        <div class="product-action">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                               data-tooltip="tooltip" title="نمایش سریع"><i class="far fa-eye"></i></a>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="product-item">
                                <div class="product-img">
                                    <span class="type discount">10% تخفیف</span>
                                    <a href="shop-single.html"><img src="{{asset('site/assets/img/product/p18.png')}}" alt></a>
                                    <div class="product-action-wrap">
                                        <div class="product-action">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                               data-tooltip="tooltip" title="نمایش سریع"><i class="far fa-eye"></i></a>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="product-item">
                                <div class="product-img">
                                    <a href="shop-single.html"><img src="{{asset('site/assets/img/product/p19.png')}}" alt></a>
                                    <div class="product-action-wrap">
                                        <div class="product-action">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                               data-tooltip="tooltip" title="نمایش سریع"><i class="far fa-eye"></i></a>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="product-item">
                                <div class="product-img">
                                    <a href="shop-single.html"><img src="{{asset('site/assets/img/product/p20.png')}}" alt></a>
                                    <div class="product-action-wrap">
                                        <div class="product-action">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                               data-tooltip="tooltip" title="نمایش سریع"><i class="far fa-eye"></i></a>
    ...
    <div class="brand-area">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="site-heading-inline">
                        <h2 class="site-title"><img src="{{asset('site/assets/img/icon/brand.svg')}}" alt>برندهای محبوب</h2>
                        <a href="#">همه برندها <i class="fas fa-arrow-left"></i></a>
                    </div>
                </div>
            </div>
            <div class="brand-slider owl-carousel owl-theme">
                <div class="brand-item">
                    <img src="{{asset('site/assets/img/brand/01.png')}}" alt>
                </div>
                <div class="brand-item">
                    <img src="{{asset('site/assets/img/brand/02.png')}}" alt>
                </div>
                <div class="brand-item">
                    <img src="{{asset('site/assets/img/brand/03.png')}}" alt>
                </div>
                <div class="brand-item">
                    <img src="{{asset('site/assets/img/brand/04.png')}}" alt>
                </div>
                <div class="brand-item">
                    <img src="{{asset('site/assets/img/brand/05.png')}}" alt>
                </div>
                <div class="brand-item">
                    <img src="{{asset('site/assets/img/brand/06.png')}}" alt>
                </div>
            </div>
        </div>
    </div>
