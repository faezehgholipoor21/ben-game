...
@section('Title')پنل مدیریت | افزودن اشتراک جدید@endsection
    ...
    <div class="container-fluid">
        <div class="block-header">
            <div class="row clearfix">
                <div class="col-md-6 col-sm-12">
                    <h1>افزودن اشتراک جدید</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">پنل مدیریت</a></li>
                            <li class="breadcrumb-item"><a href="{{route('admin.subscribe')}}">اشتراک ها</a></li>
                            <li class="breadcrumb-item active" aria-current="page">افزودن اشتراک جدید</li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="row clearfix">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form enctype="multipart/form-data" action="{{route('admin.subscribe_store')}}" method="post" class="row">
                            @csrf
                            ...
                            <div class="col-12 col-sm-7 col-md-9">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-4 mb-4">
                                        ...
                                        <span class="validation_label_error">{{$message}}</span>
                                        @enderror
                                        <input value="{{old('price')}}" dir="ltr" type="text" class="form-control" name="price">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6 mb-4">
                                        ...
                                        <span class="validation_label_error">{{$message}}</span>
                                        @enderror
                                        <input value="{{old('date')}}" dir="ltr" type="text" class="form-control" name="date">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6 mb-4">
                                        ...
                                        <span class="validation_label_error">{{$message}}</span>
                                        @enderror
                                        <input value="{{old('discount')}}" dir="ltr" type="text" class="form-control" name="discount">
                                    </div>
                                </div>
