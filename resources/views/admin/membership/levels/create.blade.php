    ...
    <div class="container-fluid">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">افزودن سطح جدید</li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="row clearfix">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form enctype="multipart/form-data" action="{{route('admin.membership_store')}}" method="post"
                              class="row">
                            @csrf
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6 mb-4">
                                        ...
                                        <span class="validation_label_error">{{$message}}</span>
                                        @enderror
                                        <input value="{{old('key')}}" dir="ltr" type="text" class="form-control"
                                               name="key">
                                    </div>
                                    <div class="col-12 col-md-6 mb-4">
                                        ...
                                        <span class="validation_label_error">{{$message}}</span>
                                        @enderror
                                        <input value="{{old('discount')}}" dir="ltr" type="text" class="form-control"
                                               name="discount">
                                        ...
                                        <span class="validation_label_error">{{$message}}</span>
                                        @enderror
                                        <input value="{{old('require_point')}}" dir="ltr" type="text" class="form-control"
                                               name="require_point">
                                    </div>
                                </div>
                            </div>
