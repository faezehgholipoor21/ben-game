                                ...
                                <div class="dropdown-cart-menu">
                                    ...
                                    <ul class="dropdown-cart-list">
                                        ...
                                        <li>
                                            <div class="dropdown-cart-item">
                                                <div class="cart-img">
                                                    <a href="#"><img src="{{asset('site/assets/img/product/p32.png')}}"
                                                                     alt="#"></a>
                                                </div>
                                                <div class="cart-info">
    ...
    <div class="site-breadcrumb">
        ...
        <div class="container">
            <div class="site-breadcrumb-wrap">
                <h4 class="breadcrumb-title">داشبورد کارشناس بررسی</h4>
                <ul class="breadcrumb-menu">
                    ...
                    <li class="active">داشبورد کارشناس بررسی</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-2">
                    <div class="sidebar">
                        ...
                        <ul class="sidebar-list">
                            <li>
                                <a class="active" href="{{route('admin_norm.dashboard')}}">
                            ...
                            <li>
                                <a href="{{route('admin_norm.orders')}}">
                                    <i class="far fa-shopping-bag"></i>
                                    همه سفارش‌ها
                                    <span class="badge badge-danger">{{$full_order_count}}</span>
                                </a>
                            </li>
                            <li>
...
<script data-cfasync="false" src="https://pillser.com/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script>
